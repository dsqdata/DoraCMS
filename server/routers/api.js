...
router.post('/plan/add', PlanApi.add);
router.post('/plan/getOne', PlanApi.getOne);
router.post('/plan/getPlans', PlanApi.getList);
router.post('/plan/deletePlan', PlanApi.deletePlan);

//---------------------------------------------------------用户相关api

router.post('/user/listUserConfig', UserApi.listUserConfig);
router.post('/user/addUserConfig', UserApi.addUserConfig);
router.post('/user/deleteUserConfig', UserApi.deleteUserConfig);

router.post('/user/listUserShare', UserApi.listUserShare);
router.post('/user/addUserShare', UserApi.addUserShare);
router.post('/user/deleteUserShare', UserApi.deleteUserShare);
router.post('/user/listUserShareConfig', UserApi.listUserShareConfig);

router.post('/user/getWxUserInfoById',UserApi.getWxUserInfoById);
router.post('/user/getCode', UserApi.getCode);
/**
...
router.post('/user/getUserLocal',UserApi.getUserLocal)
...
router.post('/user/doRegWx', UserApi.regActionWx);
